...
function chg_if_bg() {
    ...
    parent.document.getElementById('header-iframe').style.backgroundSize = "25em auto, contain";
};
...
function chg_if_bg_def() {
    ...
    parent.document.getElementById('header-iframe').style.backgroundPosition = "bottom right, bottom";
    parent.document.getElementById('header-iframe').style.backgroundRepeat = "no-repeat, no-repeat";
    parent.document.getElementById('header-iframe').style.backgroundSize = "30em auto, contain";
};
...
function post_diary() {
    ...
    fetch('/diary_check', {
        ...
        .then((res) => {
            ...
            window.location.href = "/result_diary";
        });
}
...
function post_plan() {
    ...
    fetch('/plan_check', {
        ...
        .then((res) => {
            ...
            window.location.href = "/result_plan";
        });
}
